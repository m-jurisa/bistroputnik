...
const formCopy = {
  ...
  hu: {
    ...
    intro: 'Üzenete közvetlenül a Bistro Putnik csapat e-mail címére érkezik.',
    name: 'Név',
    email: 'E-mail',
    phone: 'Telefon',
    message: 'Üzenet',
    ...
    sending: 'Küldés...',
    sent: 'Az üzenet elküldve. E-mailben válaszolunk.',
    error: 'Az üzenetet nem sikerült elküldeni. Próbálja újra, vagy írjon közvetlenül e-mailben.',
  },
  de: {
    eyebrow: 'Anfrage',
